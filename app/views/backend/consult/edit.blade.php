...
@section('title', '編輯諮詢問題 - ' . $consult->translate('cn')->title)

@section('body')

{{ Form::open(array('url' => action('BackendConsultController@update', array($consult->id)), 'method' => 'put', 'files' => true)) }}
					...
					<div class="tab-pane{{ ($lang_index == 0) ? ' active' : '' }}" id="{{ $lang->code }}">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								{{ Form::text('title[' . $lang->code . ']', $consult->translate($lang->code)->title, array('class' => 'form-control')) }}
...
{{ Form::open(array('url' => action('BackendConsultController@destroy', array($consult->id)), 'method' => 'delete', 'onsubmit' => 'return confirm("確定刪除?")')) }}
<div class="row">
	<div class="col-xs-12 col-sm-12">
		<div class="panel minimal minimal-gray">
			<div class="panel-body">
