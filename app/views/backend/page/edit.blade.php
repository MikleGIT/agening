...
@section('title', '編輯頁面 - ' . $category->translate(Config::get('site.main_lang'))->name)
@section('titleright')
<a href="{{ action('BackendCategoryController@edit', array($category->getFilteredSlug())) }}" class="btn btn-warning">頁面設定</a>
@stop

@section('body')

{{ Form::open(array('url' => action('BackendPageController@postEdit', array($category->getFilteredSlug())), 'files' => true)) }}
					...
					<div class="tab-pane{{ ($lang_index == 0) ? ' active' : '' }}" id="{{ $lang->code }}">
						...
						<div class="row title-container">
							<div class="col-xs-12">
								...
								{{ Form::text('title[' . $lang->code . ']', $page->translate($lang->code)->title, array('class' => 'form-control')) }}
						...
						<div class="row content-container">
							<div class="col-xs-12">
								...
								{{ Form::textarea('content[' . $lang->code . ']', $page->translate($lang->code)->content, array('class' => 'form-control content-editor')) }}
						...
						<div class="row excerpt-container">
							<div class="col-xs-12">
								...
								{{ Form::textarea('excerpt[' . $lang->code . ']', $page->translate($lang->code)->excerpt, array('class' => 'form-control', 'style' => 'height: 80px')) }}
...
$(function()
{
    ...
    $.ajax({
    	...
    	dataType: 'html',
    	data: {
    		'meta_key': 'category_{{ $category->id }}'
    	},
    	cache: false,
