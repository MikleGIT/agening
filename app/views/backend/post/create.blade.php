...
@section('title', '新增資料 - ' . $category->translate(Config::get('site.main_lang'))->name)

@section('body')

{{ Form::open(array('url' => action('BackendPostController@postCreate', array($category->getFilteredSlug())), 'files' => true)) }}
					...
					<div class="tab-pane{{ ($lang_index == 0) ? ' active' : '' }}" id="{{ $lang->code }}">
						...
						<div class="row content-container">
							<div class="col-xs-12">
								...
								{{ Form::textarea('content[' . $lang->code . ']', '', array('class' => 'form-control content-editor')) }}
						...
						<div class="row excerpt-container">
							<div class="col-xs-12">
								...
								{{ Form::textarea('excerpt[' . $lang->code . ']', '', array('class' => 'form-control', 'style' => 'height: 80px')) }}
