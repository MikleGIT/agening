...
<div class="row">
    <div class="col-sm-12">
        <div id="slide-home" class="carousel slide feature" data-ride="carousel" style="height: 350px">
            ...
            <div class="carousel-indicators">
                ...
                <span data-target="#slide-home" data-slide-to="{{ $news_i }}"{{ ($news_i == 0) ? ' class="active"' : '' }}>{{ ($news_i + 1) }}</span>
                @endforeach
            </div>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <?php break; ?>
                @endif
                <div class="item{{ ($news_i == 0) ? ' active' : '' }}">
                    ...
                    <a href="{{ URL::to($post->getSlug()) }}">
                        ...
                        <div class="feature-title">
                            <span>{{ $post->translate()->getExcerpt(36) }}</span> ...{{ trans('messages.read-full') }}
                        </div>
                        @else
                        <div class="feature-title" style="width: 100%">
                            <span>{{ $post->translate()->getExcerpt(100) }}</span> ...{{ trans('messages.read-full') }}
                        </div>
                        @endif
                    </a>
                </div>
    ...
    <div class="col-sm-6">
        <div class="latest-health">
            <a href="{{ URL::to(Category::findBySlug('health')->getSlug()) }}">
