...
<div class="sheet">
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                {{ $post->getMetaValue('duration', App::getLocale()) }}
            </td>
            <td>
                {{ $post->getMetaValue('fee', App::getLocale()) }}
            </td>
            <td>
                {{ $post->getMetaValue('quota', App::getLocale()) }}
            </td>
            <td>
                {{ $post->getMetaValue('start_at', App::getLocale()) }}
            </td>
            <td>
                {{ $post->getMetaValue('lesson_time', App::getLocale()) }}
            </td>
        </tr>
        @endforeach
    </table>
