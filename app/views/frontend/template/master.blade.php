            ...
            <div class="row">
                <div class="container">
                    ...
                    <div>
                        ...
                        <li style="float:right; list-style:none; width:170px; padding-right:0px; padding-top:8px;">
                        	<a href="{{ trans('messages.banner_top_url1') }}" target="_blank"><img src="{{ asset('frontend/images/banner_top1.jpg') }}" height="75" alt="{{ trans('messages.banner_top_text1') }}" title="{{ trans('messages.banner_top_text1') }}" /></a>
                        </li>
                    </div>
                </div>
            </div>
            ...
            <div{{ (isset($cssName) && $cssName == 'home') ? ' class="row"' : '' }}>
                ...
                <div class="{{ (isset($cssName) && $cssName == 'home') ? 'col-sm-4 ' : '' }}aside-wrap">
                    <div class="{{ (isset($cssName) && $cssName != 'home') ? 'col-sm-4 ' : '' }}aside match" data-mh="match-group">
                        <a href="#content" class="sr-only sr-only-focusable">{{ trans('messages.gotocontent') }}</a><!-- for Accessibility -->
...
<!--                            <a href="#search" class="gotosearch sr-only sr-only-focusable">跳至搜尋</a>-->
        ...
        <div class="footer text-center">
            <div class="container">
                ...
                <p style="display:block; margin:0 auto; text-align:center;"><a href="http://www.ias.gov.mo/" target="_blank" title="{{ trans('messages.ias_webname') }}"><img src="http://www.ias.gov.mo/wp-content/themes/ias/images/logo.png" height="70" alt="{{ trans('messages.ias_webname') }}" title="{{ trans('messages.ias_webname') }}" /></a></p>
            ...
            $("#jquery_jplayer_1").jPlayer({
                ready: function () {
                    $(this).jPlayer("setMedia", {
                        //title: "test1",
                        m4v: "http://www.ageing.ias.gov.mo/movies/page/42.mp4",
						webmv: "http://www.ageing.ias.gov.mo/movies/page/42.webm",
